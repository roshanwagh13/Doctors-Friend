...
<body>
    ...
    <div class="col-lg-2" style="padding:50px;">
        <div class="card" style="width: 18rem;" >
  			<img class="card-img-top" src="./upload/info.jpg" alt="Card image cap">
  		    <div class="card-body">
    			<h5 class="card-title" align="center">GET ALL INFORMATION</h5>
				<p>By Selecting date you will see appointments booked for that day..</p>
                <form  method="post" action="nextpage3.php">
                    <div>
                        <label for="appointment date" style="color:red;font-size:25px;">Date:</label>
                        <br>
			            <input name="apt_date_selected" type="date" id="apt_date_selected" class=heading1 required>
                    </div>
                    <div class="heading12">
                        <br>
